...
import type { NineLang } from "./types";
...
${
  lang === "root"
    ? ""
    : `You can contribute to https://github.com/nine-theme/vuepress-theme-nine/blob/main/packages/${
        plugin || "<YOUR PLUGIN>"
...
export const path2Lang = (path = "", debug = false): NineLang => {
...
export const lang2Path = (lang = "", debug = false): string => {
  if (lang in lang2PathConfig) return lang2PathConfig[lang as NineLang];
